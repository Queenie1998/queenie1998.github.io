...
<html lang = "eng">
	...
	<body>
		...
		<div class = "container-fluid admin" >
			<div class = "alert alert-primary">SIA Student List</div>
			...
			<div class = "well col-lg-12">
				<table id="table" class="table table-bordered table-striped">
					...
					<tbody>
                        <?php
					$query =$conn->query("SELECT employee_no,firstname,lastname,position FROM `employee` where position ='SIA' " ) or die(mysqli_error($conn));
