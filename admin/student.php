	...
	<body>
		...
		<div class="container-fluid admin" >
			...
			<div class="well col-lg-12">
				<button class="btn btn-success" type="button" id="new_emp_btn"><span class="fa fa-plus"></span> Add new Student </button>
				<br />
				<br />
				<table id="table" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<center>
								 <button class="btn btn-sm btn-outline-secondary edit_employee" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-edit"></i></button>
								<button class="btn btn-sm btn-outline-secondary remove_employee" data-id="<?php echo $row['id']?>" type="button"><i class="fa fa-trash"></i></button>
								</center>
							</td>
						</tr>
						<?php
