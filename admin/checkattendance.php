								...
								<div class="text-center mb-4" id="log_display"></div>
									<form action="" id="att-log-frm" >
										...
										<center>
											...
											<button type="button" class='btn btn-outline-secondary  log_now col-sm-3' data-id="1"> In-AM</button> 
											<button type="button" class='btn btn-outline-secondary  log_now col-sm-3' data-id="2">OUT-AM</button> <br>
											<button type="button" class='btn btn-outline-secondary log_now col-sm-3' data-id="3">IN-PM</button> 
											<button type="button" class='btn btn-outline-secondary  log_now col-sm-3' data-id="4">OUT-PM</button>
										</center>
